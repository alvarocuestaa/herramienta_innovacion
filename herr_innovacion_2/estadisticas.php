    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-secondary fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item active nav-link" href="estadisticas.php">Estadísticas</a>
            </div>
        </div>
    </nav>
    ...
    <section class="page-section  bg-light" id="estadisticas">
        <div class="container">
            <div class="text-center">
                ...
                <br>
                <hr>
                <p class="text-center">¡Rellene los datos de su empresa para poder compararse con otras empresas!</p>
                <a class="btn btn-primary " href="formulario.php">Ir a evaluación</a>
                <hr>
            </div>
            ...
            <form id="contactForm" name="sentMessage" novalidate="novalidate">
                ...
                <div class="row align-items-stretch mb-5">
                    ...
                    <div class="form-group">
                        <button name="button" type="button" class="btn btn-primary" onclick="verEstadisticas()">Ver
                            estadísticas</button>
                    </div>
                </div>
            </form>
