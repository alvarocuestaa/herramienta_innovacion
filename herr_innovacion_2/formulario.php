...
<head>
    ...
    <meta name="description" content="Evaluación del carácter innovador" />
    <meta name="author" content="Alvaro Cuesta Garcia" />
    <title>Innovacion en las PYMES - Evaluación</title>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-secondary fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link active" href="formulario.php">Autoevaluación</a>
                <a class="nav-item nav-link" href="estadisticas.php">Estadísticas</a>
            </div>
        </div>
    </nav>

    <!-- Seccion de Cuestionario-->
    <section class="page-section  bg-light" id="formulario">
        <div class="container">
            <div class="text-center">
                <h3 class="section-heading">Descubra el carácter innovador de su empresa</h3>
                <br>
                <hr>
            </div>

            <h4 class="text-muted">Datos generales de la empresa</h4>
            <hr>
            <form id="contactForm" name="sentMessage" novalidate="novalidate">
                ...
                <div class="row align-items-stretch mb-5">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="eval_nombre" type="text" placeholder="Nombre (Opcional)" />

                        </div>
                        <div class="form-group">
                            <label>P&aacute;gina web </label>
                            <input class="form-control" id="eval_web" type="text" placeholder="URL (Opcional)" />

                        </div>
                        <label>N&uacute;mero de Empleados (FTEs)</label>
                        <div class="form-group">
                            <select class="form form-control" id="eval_num_empleados">
                    ...
                    <div class="col-md-4">
                        <label>Comunidad aut&oacute;noma</label>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="eval_cp" type="text" placeholder="CP (Opcional)" />
                        </div>
                        <label>Año de constituci&oacute;n</label>
                        <div class="form-group">
                            <select class="form form-control" id="eval_ano_constitucion">
                    ...
                    <div class="col-md-4">
                        <label>Actividad econ&oacute;mica (C&oacute;digo CNAE)</label>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Pincipales actividades/productos y servicios </label>
                            <input class="form-control" id="eval_actividades" type="text" placeholder="Descripci&oacute;n (Opcional)" />

                        </div>
                        <div class="form-group">
                            <label>Facturaci&oacute;n del último ejercicio (€)</label>
                            <input class="form-control" id="eval_facturacion" type="number" placeholder="Facturaci&oacute;n de la empresa" value='0' />

                        </div>
                    </div>
                </div>
                <hr>
                <h4 class="text-muted">Indicadores de innovaci&oacute;n de la empresa</h4>
                <hr>

                <h2>1.- Recursos aplicados</h2>
                <h4>1.1- Recursos Humanos</h4>
                <div class="form-group">
                    <label for="selectPreguntaARH">a) N&uacute;mero total de empleados en I+D+i en el &uacute;ltimo a&ntilde;o (FTEs)</label>
                    <div>
                        <select id="selectPreguntaARH" name="selectPreguntaARH" required="required" class="custom-select col-md-2">
                ...
                <div class="form-group">
                    <label for="selectPreguntaBRH">b) N&uacute;mero total de graduados en I+D+i en el &uacute;ltimo a&ntilde;o (FTEs)</label>
                    <div>
                        <select id="selectPreguntaBRH" name="selectPreguntaBRH" required="required" class="custom-select col-md-2">
                            <option value="0">0</option>
                            <option value="1">1</option>
                            <option value="2">2</option>
                            <option value="3">3</option>
                ...
                <div class="form-group">
                    <label for="selectPreguntaCRH">c) &iquest;Se compensa de alguna manera la dedicaci&oacute;n
                        voluntaria a las actividades innovadoras?</label>
                    <div>
                        <select id="selectPreguntaCRH" name="selectPreguntaCRH" required="required" class="custom-select col-md-2">
                            <option value="0">No</option>
                            <option value="10">S&iacute;</option>
                        </select>
                    </div>
                </div>
                <h4>1.2- Recursos econ&oacute;micos-financieros:</h4>
                <div class="form-group">
                    <label for="selectPreguntaAREF">a) &iquest;La empresa ha obtenido financiaci&oacute;n p&uacute;blica
                        internacional de la I+D+i?</label>
                    <div>
                        <select id="selectPreguntaAREF" name="selectPreguntaAREF" class="custom-select col-md-2" required="required">
                            <option value="0">No</option>
                ...
                <div class="form-group">
                    <label for="selectPreguntaBREF">b) &iquest;La empresa ha obtenido financiaci&oacute;n p&uacute;blica
                        nacional de la I+D+i?</label>
                    <div>
                        <select id="selectPreguntaBREF" name="selectPreguntaBREF" class="custom-select col-md-2" required="required">
                            <option value="0">No</option>
                            <option value="15">S&iacute;</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    <label for="selectPreguntaCREF">c) &iquest;La empresa ha obtenido becas p&uacute;blicas de
                        investigaci&oacute;n?</label>
                    <div>
                        <select id="selectPreguntaCREF" name="selectPreguntaCREF" required="required" class="custom-select col-md-2">
                            <option value="0">No</option>
                            <option value="5">S&iacute;</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    <label for="selectPreguntaDREF">d) &iquest;La empresa ha captado financiaci&oacute;n privada de la
                        I+D+i?</label>
                    <div>
                        <select id="selectPreguntaDREF" name="selectPreguntaDREF" class="custom-select col-md-2" required="required">
                            <option value="0">No</option>
                            <option value="15">S&iacute;</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label for="selectPreguntaEREF">e) Gasto en I+D+i de media en los &uacute;ltimos tres a&ntilde;os (€)</label>
                    <div>
                        <input class="form-control col-md-2 mb-3" id="selectPreguntaEREF" name="selectPreguntaEREF" type="number" value='0' required="required" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="selectPreguntaFREF">f) Gasto en I+D de media en los &uacute;ltimos tres a&ntilde;os (€)</label>
                    <div>
                        <input class="form-control col-md-2 mb-3" id="selectPreguntaFREF" name="selectPreguntaFREF" type="number" value='0' required="required" />
                    </div>
                </div>
                <h2>2.- Proceso de innovaci&oacute;n</h2>
                <h4>2.1- Forma de innovar:</h4>
                <div class="form-group">
                    <label for="selectPreguntaAFI">a) Gasto en I+D de forma externa (subcontrataciones, innovaci&oacute;n abierta, etc.) de media en los &uacute;ltimos tres
                        a&ntilde;os (€)</label>
                    <div>
                        <input class="form-control col-md-2 mb-3" id="selectPreguntaAFI" name="selectPreguntaAFI" type="number" value='0' required="required" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="selectPreguntaBFI">b) &iquest;Se realiza I+D+i en colaboraci&oacute;n con otros
                        organismos (empresas, universidades, etc.)?</label>
                    <div>
                        <select id="selectPreguntaBFI" name="selectPreguntaBFI" class="custom-select col-md-2" required="required">
                            <option value="0">No</option>
                            <option value="60">S&iacute;</option>
                        </select>
                    </div>
                </div>
                <h4>2.2- Organizaci&oacute;n de la innovaci&oacute;n:</h4>
                <div class="form-group">
                    <label for="selectPreguntaAOI">a) &iquest;Aplica alg&uacute;n proceso sistem&aacute;tico para
                        relacionarse con suministradores para aumentar la capacidad innovadora de la empresa?</label>
                    <div>
                        <select id="selectPreguntaAOI" name="selectPreguntaAOI" class="custom-select col-md-2" required="required">
                            <option value="0">No</option>
                            <option value="10">S&iacute;</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label for="selectPreguntaBOI">b) &iquest;Hay alguien en la empresa que tiene la obligaci&oacute;n
                        de conocer las novedades del mercado para aumentar la capacidad innovadora de la
                        empresa?</label>
                    <div>
                        <select id="selectPreguntaBOI" name="selectPreguntaBOI" class="custom-select col-md-2" required="required">
                            <option value="0">No</option>
                            <option value="10">S&iacute;</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label for="selectPreguntaCOI">c) &iquest;Aplica alg&uacute;n proceso sistem&aacute;tico para
                        conseguir realimentaci&oacute;n del cliente para aumentar la capacidad innovadora de la
                        empresa?</label>
                    <div>
                        <select id="selectPreguntaCOI" name="selectPreguntaCOI" class="custom-select col-md-2">
                            <option value="0">No</option>
                            <option value="10">S&iacute;</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label for="selectPreguntaDOI">d) &iquest;Existe una contabilidad anal&iacute;tica que identifique
                        de forma diferenciada las actividades de innovaci&oacute;n?</label>
                    <div>
                        <select id="selectPreguntaDOI" name="selectPreguntaDOI" class="custom-select col-md-2">
                            <option value="0">No</option>
                ...
                <div class="form-group">
                    <label for="selectPreguntaEOI">e) &iquest;Aplica un proceso sistem&aacute;tico para relacionarse con
                        organizaciones de formaci&oacute;n o servicios tecnol&oacute;gicos, como p.ej. laboratorios de
                        certificaci&oacute;n o centros tecnol&oacute;gicos, para aumentar la capacidad innovadora de la
                        empresa?</label>
                    <div>
                        <select id="selectPreguntaEOI" name="selectPreguntaEOI" class="custom-select col-md-2">
                            <option value="0">No</option>
                            <option value="10">S&iacute;</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label for="selectPreguntaFOI">f) &iquest;La pol&iacute;tica de comunicaci&oacute;n incluye los
                        resultados de la capacidad innovadora de la empresa?</label>
                    <div>
                        <select id="selectPreguntaFOI" name="selectPreguntaFOI" class="custom-select col-md-2">
                            <option value="0">No</option>
                            <option value="10">S&iacute;</option>
                        </select>
                    </div>
                </div>
                <h2>3- Resultados y valorizaci&oacute;n:</h2>
                <h4>3.1- Registros de propiedad:</h4>
                <div class="form-group">
                    <label for="selectPreguntaAR">a) &iquest;Se han registrado patentes y modelos de utilidad nacionales
                        en los &uacute;ltimos tres a&ntilde;os?</label>
                    <div>
                        <select id="selectPreguntaAR" name="selectPreguntaAR" class="custom-select col-md-2" required="required">
                            <option value="0">No</option>
                            <option value="20">S&iacute;</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label for="selectPreguntaBR">b) &iquest;Se han registrado patentes en el &aacute;mbito
                        internacional en los &uacute;ltimos tres a&ntilde;os?</label>
                    <div>
                        <select id="selectPreguntaBR" name="selectPreguntaBR" class="custom-select col-md-2" required="required">
                            <option value="0">No</option>
                            <option value="20">S&iacute;</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label for="selectPreguntaCR">c) &iquest;Se han registrado dise&ntilde;os industriales nacionales,
                        de la UE o internacionales en los &uacute;ltimos tres a&ntilde;os?</label>
                    <div>
                        <select id="selectPreguntaCR" name="selectPreguntaCR" class="custom-select col-md-2" required="required">
                            <option value="0">No</option>
                            <option value="10">S&iacute;</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label for="selectPreguntaDR">d) &iquest;Se han registrado marcas nacionales, de la UE o
                        internacionales en los &uacute;ltimos tres a&ntilde;os?</label>
                    <div>
                        <select id="selectPreguntaDR" name="selectPreguntaDR" class="custom-select col-md-2" required="required">
                            <option value="0">No</option>
                            <option value="10">S&iacute;</option>
                        </select>
                    </div>
                </div>
                <h4>3.2- Resultado del proceso:</h4>
                <div class="form-group">
                    <label for="selectPreguntaARP">a) &iquest;Se han introducido en el mercado productos o servicios
                        innovadores, o implantado procesos innovadores en los &uacute;ltimos tres a&ntilde;os?</label>
                    <div>
                        <select id="selectPreguntaARP" name="selectPreguntaARP" class="custom-select col-md-2" required="required">
                            <option value="0">No</option>
                ...
                <div class="form-group">
                    <label for="selectPreguntaBRP">b) &iquest;Se han introducido t&eacute;cnicas innovadoras de
                        marketing en los &uacute;ltimos tres a&ntilde;os?</label>
                    <div>
                        <select id="selectPreguntaBRP" name="selectPreguntaBRP" class="custom-select col-md-2" required="required">
                            <option value="0">No</option>
                            <option value="30">S&iacute;</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <label for="selectPreguntaCRP">c) &iquest;Destaca su publicidad la innovaci&oacute;n de sus
                        productos?</label>
                    <div>
                        <select id="selectPreguntaCRP" name="selectPreguntaCRP" class="custom-select col-md-2">
                            <option value="0">No</option>
                            <option value="10">S&iacute;</option>
                        </select>
                    </div>
                </div>
                <h4>3.3- Empleo en I+D+i:</h4>
                <div class="form-group">
                    <label for="selectPreguntaAEIDI">a) Número de contrataciones en I+D+i en los &uacute;ltimos tres a&ntilde;os (FTEs) </label>
                    <div>
                        <input class="form-control col-md-2 mb-3" id="selectPreguntaAEIDI" name="selectPreguntaAEIDI" type="number" value='0' required="required" />
                    </div>
                </div>
                <h4>3.4- Retorno econ&oacute;mico:</h4>
                <div class="form-group">
                    <label for="selectPreguntaARE">a) Ingresos por licencia de patentes en los &uacute;ltimos tres a&ntilde;os (€)</label>
                    <div>
                        <input class="form-control col-md-2 mb-3" id="selectPreguntaARE" name="selectPreguntaARE" type="number" value='0' required="required" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="selectPreguntaBRE">b.1) Ventas totales en la empresa en los &uacute;ltimos tres a&ntilde;os</label>
                    <div>
                        <input class="form-control col-md-2 mb-3" id="selectPreguntaBRE" name="selectPreguntaBRE" type="number" value='0' required="required" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="selectPreguntaBBRE">b.2) Ventas de productos nuevos para el mercado o para la empresa en los &uacute;ltimos tres a&ntilde;os</label>
                    <div>
                        <input class="form-control col-md-2 mb-3" id="selectPreguntaBBRE" name="selectPreguntaBBRE" type="number" value='0' required="required" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="selectPreguntaCRE">c.1) Exportaciones totales en la empresa en los &uacute;ltimos tres a&ntilde;os </label>
                    <div>
                        <input class="form-control col-md-2 mb-3" id="selectPreguntaCRE" name="selectPreguntaCRE" type="number" value='0' required="required" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="selectPreguntaCCRE">c.2) Exportaciones de productos nuevos para el mercado o para la empresa en los &uacute;ltimos tres a&ntilde;os </label>
                    <div>
                        <input class="form-control col-md-2 mb-3" id="selectPreguntaCCRE" name="selectPreguntaCCRE" type="number" value='0' required="required" />
                    </div>
                </div>
                <div class="form-group">
                    <button name="button" type="button" class="btn btn-primary" onclick="obtenerDatos()">Enviar</button>
                </div>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="modalRecomendaciones">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Recomendaciones para mejorar el carácter innovador de su empresa</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" id="recomendaciones">

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <a class="btn btn-primary" href="estadisticasComp.php">Ver estadísticas</a>
                </div>
            </div>
        </div>
    </div>
